...
//
// JAX's partitionable split path maps split(key, n)[i] to
// threefry2x32(key, counter=(0, i)). Keeping the same stream is part of the
// environment contract: substituting a faster hash changes seeded worlds and
// trajectories, invalidating parity and reproducibility.
